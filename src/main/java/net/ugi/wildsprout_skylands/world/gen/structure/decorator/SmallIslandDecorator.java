...
/**
 * Decoration strategy for SMALL islands.
 * No top-surface vegetation, but still places hanging roots on the underside.
 */
public class SmallIslandDecorator implements IslandDecorator {
    @Override
    public void decorateSurface(WorldGenLevel world, ChunkGenerator generator, BlockPos.MutableBlockPos pos, 
        ...
        // Small islands do not have top-surface vegetation.
    }
